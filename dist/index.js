...
for (let i = 0; i < colos; i++) {
    ...
    addressRowCont === null || addressRowCont === void 0 ? void 0 : addressRowCont.appendChild(addressRow);
}
//creating cell 
for (let i = 0; i < row; i++) {
    ...
    cellCont === null || cellCont === void 0 ? void 0 : cellCont.appendChild(rowCont);
}
//to find cell address
function addEventListnerForAddressBar(cell, i, j) {
